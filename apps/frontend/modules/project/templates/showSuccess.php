...
<p><?php echo __('API Token:'); ?><br><code><?php echo $project->token; ?></code></p>
<?php end_slot(); ?>
...
<table class="zebra-striped">
    ...
    <?php if (count($project->Resources) > 0): ?>
        ...
        <tr>
            <td>
                <?php echo link_to(icon_tag('box') . $resource->name, 'resource', $resource); ?>
                <?php if ($resource->base_resource_id !== null): ?>
                    <br><small><?php echo icon_tag('arrow-merge-270').$resource->BaseResource->name; ?></small>
                <?php endif; ?>
            </td>
