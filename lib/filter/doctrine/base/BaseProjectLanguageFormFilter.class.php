...
/**
 * ProjectLanguage filter form base class.
 *
 * @package    xliffeditor
 * @subpackage filter
 ...
 */
abstract class BaseProjectLanguageFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('project_language_filters[%s]');
