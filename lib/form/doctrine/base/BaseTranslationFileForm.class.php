...
/**
 * TranslationFile form base class.
 *
 * @method TranslationFile getObject() Returns the current form's model object
 *
 * @package    xliffeditor
 * @subpackage form
 ...
 */
abstract class BaseTranslationFileForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('translation_file[%s]');
